...
function detectDeviceAndAddClass() {
    ...
    if (/android/i.test(userAgent)) {
        ...
        if (/ipad/i.test(userAgent)) {
            ...
            const match = userAgent.match(/iphone\s*(?:3gs|4|4s|5|5c|5s|6|6 plus|6s|6s plus|se|7|7 plus|8|8 plus|x|xs|xs max|xr|11|11 pro|11 pro max|12|12 mini|12 pro|12 pro max|13|13 mini|13 pro|13 pro max|14|14 plus|14 pro|14 pro max)/i);
    ...
    if (/iphone/i.test(userAgent)) {
        const notchModels = ['x', 'xs', 'xs max', 'xr', '11', '11 pro', '11 pro max', '12', '12 mini', '12 pro', '12 pro max', '13', '13 mini', '13 pro', '13 pro max', '14', '14 plus', '14 pro', '14 pro max'];
